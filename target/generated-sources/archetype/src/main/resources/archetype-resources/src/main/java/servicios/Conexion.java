...
public class Conexion implements  ConexionInterface {
	...
	private String[] configuracionConexion() {
		...
		try {
			propiedadesConexion.load(new FileInputStream(new File("C:${symbol_escape}${symbol_escape}Users${symbol_escape}${symbol_escape}Puesto20${symbol_escape}${symbol_escape}eclipse-workspace${symbol_escape}${symbol_escape}ConnectionBDJAVA${symbol_escape}${symbol_escape}src${symbol_escape}${symbol_escape}Util${symbol_escape}${symbol_escape}conexion_postgresql.properties")));
